...
export function isCreateArgs(
  args: Record<string, unknown>,
): args is CreateArgs {
  return typeof args.path === "string" && typeof args.file_text === "string";
}

export function isStrReplaceArgs(
  args: Record<string, unknown>,
): args is StringReplaceArgs {
  return (
    typeof args.path === "string" &&
...
export function isUndoEditArgs(
  args: Record<string, unknown>,
): args is UndoEditArgs {
